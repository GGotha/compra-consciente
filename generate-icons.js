...
// SVG de base com moeda/cifrão
const baseSvg = `
<svg xmlns="http://www.w3.org/2000/svg" width="SIZE" height="SIZE" viewBox="0 0 93.576 93.576">
  <g>
    <path style="fill:#FFE101;" d="M46.783,3C22.641,3,3,22.641,3,46.783C3,70.93,22.641,90.576,46.783,90.576
      ...
      c0-19.226,15.642-34.867,34.868-34.867c19.231,0,34.878,15.642,34.878,34.867C81.661,66.015,66.015,81.662,46.783,81.662z"></path>
    ...
    <path style="fill:#FFFFFF;" d="M46.783,14.916c-17.572,0-31.868,14.296-31.868,31.867c0,17.578,14.296,31.879,31.868,31.879
      ...
      c0.594,1.402,0.691,3.008,0.691,4.774V53.258z"></path>
    <path d="M46.783,11.916c-19.227,0-34.868,15.642-34.868,34.867c0,19.232,15.642,34.879,34.868,34.879
      ...
      C78.661,64.361,64.36,78.662,46.783,78.662z"></path>
    <path style="fill:#FFE101;" d="M57.889,46.988c-0.906-0.772-2.068-1.458-3.454-2.037c-1.46-0.605-3.237-1.145-5.205-1.602
      ...
      c1.615,0.458,2.687,0.961,3.355,1.582c0.785,0.732,1.195,1.701,1.195,2.805C54.507,55.279,53.879,57.617,49.704,58.053z"></path>
    <path d="M59.834,44.704c-1.142-0.974-2.606-1.821-4.283-2.522c-1.316-0.546-2.519-1.038-4.519-1.47v-2.819
      ...
      c0.67-1.459,0.825-3.104,0.825-4.887v-0.109c0-1.767-0.088-3.372-0.682-4.774C61.75,46.968,61.044,45.733,59.834,44.704z M60.032,53.258
      c0,1.349-0.035,2.572-0.517,3.624c-0.499,1.063-1.104,2.001-2.004,2.786c-0.928,0.804-2.013,1.458-3.328,1.942
      ...
      c0.435,1.026,0.447,2.238,0.447,3.601V53.258z"></path>
    <path d="M49.957,49.438l-1.924-0.541v9.329l1.671-0.173c4.176-0.437,4.807-2.774,4.807-4.229c0-1.104-0.418-2.072-1.203-2.805
      ...
      c0.146,0.136,0.243,0.292,0.243,0.708c0,0.151,0,0.454-0.456,0.72V53.062z"></path>
    <path d="M41.201,35.152c-0.862,0.757-1.168,1.746-1.168,2.861v0.104c0,1.11,0.26,2.072,1.042,2.79
      ...
      c0.032-0.028,0.1-0.078,0.221-0.137V38.88z"></path>
  </g>
</svg>
`;
...
// Comentado pois não está sendo usado após a remoção da geração de PNGs
...
// NOTA: A conversão direta de SVG para PNG requer bibliotecas adicionais como sharp, canvas, etc.
// Por enquanto, os arquivos HTML gerados podem ser usados para salvar manualmente os PNGs
console.log('\nIMPORTANTE: Para gerar os PNGs corretos com o novo ícone:');
console.log('1. Abra os arquivos HTML gerados em dist/icons/ no navegador');
console.log('2. Clique com o botão direito em cada ícone e selecione "Salvar imagem como..."');
console.log('3. Salve os PNGs na pasta public/icons/ com os nomes icon16.png, icon48.png e icon128.png\n');

console.log('\nPronto! Os ícones SVG foram gerados.');
